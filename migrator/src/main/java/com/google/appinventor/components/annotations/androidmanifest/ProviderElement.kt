 ...
 *
 * See [][<a href=]//developer.android.com/guide/topics/manifest/provider-element">">&lt;a href=&quot;https://developer.android.com/guide/topics/manifest/provider-element&quot;&gt;.
 *
 * @author https://github.com/ShreyashSaitwal (Shreyash Saitwal)
</provider></provider></provider> */
@kotlin.annotation.Retention(AnnotationRetention.RUNTIME)
@Target(AnnotationTarget.ANNOTATION_CLASS, AnnotationTarget.CLASS)
annotation class ProviderElement(
    /**
    ...
    val pathPermissionElement: Array<PathPermissionElement> = [],
    /**
     * An array containing any path permissions used by this <provider> element.
     *
     * @return  an array containing the <path-permission> subelements for this
    ...
    val grantUriPermissionElement: Array<GrantUriPermissionElement> = [],
    /**
     ...
     */
    val directBootAware: String = "false",
    /**
    ...
    val grantUriPermissions: String = "",
    /**
     ...
     * However, the [.readPermission], [.writePermission], and [.grantUriPermissions]
     * attributes take precedence over this one. If the [.readPermission] attribute is also set,

 ...
 *
 * See [][<a href=]//developer.android.com/guide/topics/manifest/activity-element.html">">&lt;a href=&quot;https://developer.android.com/guide/topics/manifest/activity-element.html&quot;&gt;.
 *
 * @author will2596@gmail.com (William Byrne)
</activity></activity> */
@kotlin.annotation.Retention(AnnotationRetention.RUNTIME)
@Target(AnnotationTarget.ANNOTATION_CLASS, AnnotationTarget.CLASS)
annotation class ActivityElement(
    /**
    ...
    val allowTaskReparenting: String = "",
    /**
     ...
     */
    val alwaysRetainTaskState: String = "",
    /**
     ...
     */
    val autoRemoveFromRecents: String = "",
    /**
     ...
     * in some situations (see the [.alwaysRetainTaskState] attribute),
     * but not always.
     *
     ...
     *
     * [][<a href=]//developer.android.com/guide/topics/manifest/activity-element.html.config">">&lt;a href=&quot;https://developer.android.com/guide/topics/manifest/activity-element.html#config&quot;&gt;.
     *
     ...
     * For more information on these attribute values, see
     *
     * [][<a href=]//developer.android.com/guide/topics/manifest/activity-element.html.dlmode">">&lt;a href=&quot;https://developer.android.com/guide/topics/manifest/activity-element.html#dlmode&quot;&gt;.
     *
     * @return  the activity documentLaunchMode attribute
     */
    val documentLaunchMode: String = "",
    /**
     ...
     * can invoke the activity (see the [.permission] attribute).
     *
     ...
     *
     * If this attribute and [.allowTaskReparenting] are both "true", this
     ...
     * The icon is often accompanied by a label (see the [.label]
     * attribute).
     *
     * This attribute must be set as a reference to a drawable resource containing
     ...
     * [IntentFilterElement.icon] attribute).
     *
     ...
     * [IntentFilterElement.label] attribute).
     *
     ...
     * [android.content.Intent] objects to determine what should happen when
     ...
     * that called [android.content.Context.startActivity]
     * (unless the Intent object contains a [android.content.Intent.FLAG_ACTIVITY_NEW_TASK]
     ...
     * [android.app.Activity.onNewIntent] call); a new
     ...
     * [android.app.Activity.onNewIntent] method. If
     * the parent activity has launch mode standard (and the up intent does not
     * contain [android.content.Intent.FLAG_ACTIVITY_CLEAR_TOP]), the current
     ...
     * if [android.content.Intent.FLAG_ACTIVITY_NEW_TASK] was in the intent.
     *
     ...
     * match the class name given to the corresponding [ActivityElement.name]
     * attribute.
     *
     ...
     * a [MetaDataElement] that specifies a value for "android.support.PARENT_ACTIVITY".
     *
     ...
     * or [android.app.Activity.startActivityForResult]
     ...
     * [android.app.ActivityManager.TaskDescription] to change labels,
     * colors and icons in the overview screen.
     *
     * @return  the activity relinquishTaskIdentity attribute
     */
    val relinquishTaskIdentity: String = "",
    /**
     ...
     * For more information on these attribute values, see
     *
     * [][<a href=]//developer.android.com/guide/topics/manifest/activity-element.html.screen">">&lt;a href=&quot;https://developer.android.com/guide/topics/manifest/activity-element.html#screen&quot;&gt;.
     *
     ...
     * re-parented to (see the [.allowTaskReparenting] attribute) and the
     ...
     *
     * For details see [com.google.appinventor.buildserver.Compiler.writeAndroidManifest].
     *
     ...
     * (see [android.content.Context.setTheme], and may also cause
     ...
     * For more information on these attribute values, see
     *
     * [][<a href=]//developer.android.com/guide/topics/manifest/activity-element.html.wsoft">">&lt;a href=&quot;https://developer.android.com/guide/topics/manifest/activity-element.html#wsoft&quot;&gt;.
     *
     * @return  the activity windowSoftInputMode attribute
     */
    val windowSoftInputMode: String = ""
)

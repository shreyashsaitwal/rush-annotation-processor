...
//    return d < 0 ? 0 : d;
  ...
  public static double distanceBetweenEdges(MapLineString lineString, MapCircle circle) {
    double d = (ONE_DEG_IN_METERS * lineString.getGeometry().distance(createGeometry((List<GeoPoint>) circle.getCentroid()))) - circle.Radius();
    return d < 0 ? 0 : d;
  }
  ...
  public static double distanceBetweenEdges(MapPolygon polygon, MapCircle circle) {
    double d = (ONE_DEG_IN_METERS * polygon.getGeometry().distance(createGeometry((List<GeoPoint>) circle.getCentroid()))) - circle.Radius();
    return d < 0 ? 0 : d;
  }
  ...
  public static double distanceBetweenEdges(MapCircle circle, MapRectangle rectangle) {
    double d = (ONE_DEG_IN_METERS * rectangle.getGeometry().distance(createGeometry((List<GeoPoint>) circle.getCentroid()))) - circle.Radius();
    return d < 0 ? 0 : d;
  }

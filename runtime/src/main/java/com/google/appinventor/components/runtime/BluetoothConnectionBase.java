...
public abstract class BluetoothConnectionBase extends AndroidNonvisibleComponent
   ...
   */
  @SimpleProperty(description = "On devices with API level 14 (LEVEL_ICE_CREAM_SANDWICH) or higher, " +
   ...
   */
  @SimpleProperty(description = "Whether to invoke SSP (Simple Secure Pairing), which is supported on " +

...
public class PhoneStatus extends AndroidNonvisibleComponent implements Component {
  ...
  public static String GetWifiIpAddress() {
    DhcpInfo ip;
    @SuppressLint("WrongConstant") Object wifiManager = activity.getSystemService("wifi");
  ...
  public static boolean isConnected() {
    @SuppressLint("WrongConstant") ConnectivityManager connectivityManager = (ConnectivityManager) activity.getSystemService("connectivity");

...
public class Circle extends PolygonBase implements MapCircle {
   ...
   */
  @Override
  @SimpleProperty(description = "The radius of the circle in meters.")
   ...
   */
  @Override
  @SimpleProperty(description = "The latitude of the center of the circle.")
   ...
   */
  @Override
  @SimpleProperty(description = "The longitude of the center of the circle.")

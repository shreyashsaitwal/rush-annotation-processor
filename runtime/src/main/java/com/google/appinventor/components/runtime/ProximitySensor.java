...
public class ProximitySensor extends AndroidNonvisibleComponent
     ...
     */
    @SimpleProperty(description = "Reports whether or not the device has a proximity sensor.")
     ...
     */
    @SimpleProperty(description = "Reports the Maximum Range of the device's ProximitySensor")
     ...
     * @return  distance
     */
    @SimpleProperty(description = "Returns the distance from the object to the device")
